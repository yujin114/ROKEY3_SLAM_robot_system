...
class BFSAndValidatorNode(Node):
    def __init__(self):
        super().__init__('bfs_path_finder1')
        ...
        # ─── Subscribers ────────────────────────────
        self.create_subscription(String, '/robot1/bfs/state_pose', self.state_callback, 10)
        self.create_subscription(String, '/robot1/bfs/goal_pose', self.goal_callback, 10)
        self.create_subscription(String, '/robot1/bfs/path', self.path_callback, 10)

        # ─── Publishers ─────────────────────────────
        self.path_pub = self.create_publisher(String, '/robot1/bfs/path', 10)
        self.pose_pub = self.create_publisher(String, '/robot1/bfs/next_pose', 10)
