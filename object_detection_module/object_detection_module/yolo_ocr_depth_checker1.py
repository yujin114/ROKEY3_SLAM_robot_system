...
RGB_TOPIC = '/robot1/oakd/rgb/image_fast/compressed'
DEPTH_TOPIC = '/robot1/oakd/stereo/image_raw'  # ✅ Raw depth 토픽으로 변경
...
class YoloOCRDepthChecker(Node):
    def __init__(self):
        ...
        self.distance_publisher = self.create_publisher(Int32, '/robot1/event', qos)        # 거리용
